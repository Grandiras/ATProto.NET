...
public partial class LexiconDriftTests
{
    ...
    private static readonly Dictionary<Type, string> DefOf = new()
    {
        ...
        [typeof(Bsky.AgeAssurance.AgeAssuranceState)] = "app.bsky.ageassurance.defs#state",
        [typeof(Bsky.AgeAssurance.AgeAssuranceStateMetadata)] = "app.bsky.ageassurance.defs#stateMetadata",
        [typeof(Bsky.AgeAssurance.AgeAssuranceConfig)] = "app.bsky.ageassurance.defs#config",
        [typeof(Bsky.AgeAssurance.AgeAssuranceRegion)] = "app.bsky.ageassurance.defs#configRegion",
        ...
        [typeof(Bsky.Notification.NotificationPreferences)] = "app.bsky.notification.defs#preferences",
        [typeof(Bsky.Notification.NotificationPreference)] = "app.bsky.notification.defs#preference",
        [typeof(Bsky.RichText.FacetIndex)] = "app.bsky.richtext.facet#byteSlice",
        // getPostThreadV2 and getPostThreadOtherV2 each declare a threadItem of the same shape.
        [typeof(Bsky.Unspecced.ThreadItem)] = "app.bsky.unspecced.getPostThreadV2#threadItem",
    ...
    [
        ("ATProtoNet.Lexicon.App.Bsky.Actor.ActorStatus", "app.bsky.actor.status:status"),
        ("ATProtoNet.Lexicon.App.Bsky.Actor.VerificationStatus", "app.bsky.actor.defs#verificationState:verifiedStatus"),
        ("ATProtoNet.Lexicon.App.Bsky.AgeAssurance.AgeAssuranceAccess", "app.bsky.ageassurance.defs#access"),
        ("ATProtoNet.Lexicon.App.Bsky.AgeAssurance.AgeAssuranceStatus", "app.bsky.ageassurance.defs#status"),
        ...
        ("ATProtoNet.Lexicon.App.Bsky.Feed.InteractionEvent", "app.bsky.feed.defs#interaction:event"),
        ("ATProtoNet.Lexicon.App.Bsky.Feed.PostSearchSort", "app.bsky.feed.searchPostsV2#params:sort"),
        ("ATProtoNet.Lexicon.App.Bsky.Feed.SearchQueryLanguage", "app.bsky.feed.searchPostsV2#params:queryLanguage"),
        ...
        ("ATProtoNet.Lexicon.App.Bsky.Notification.AllowedSubscribers", "app.bsky.notification.declaration:allowSubscriptions"),
        ("ATProtoNet.Lexicon.App.Bsky.Notification.NotificationInclude", "app.bsky.notification.defs#filterablePreference:include"),
        ("ATProtoNet.Lexicon.App.Bsky.Notification.NotificationReasons", "app.bsky.notification.listNotifications#notification:reason"),
        ("ATProtoNet.Lexicon.App.Bsky.Notification.PushPlatform", "app.bsky.notification.registerPush#input:platform"),
        ("ATProtoNet.Lexicon.App.Bsky.Unspecced.PostThreadSort", "app.bsky.unspecced.getPostThreadV2#params:sort"),
        ...
        ("ATProtoNet.Lexicon.App.Bsky.Video.UploadState", "app.bsky.video.getUploadStatus#output:state"),
